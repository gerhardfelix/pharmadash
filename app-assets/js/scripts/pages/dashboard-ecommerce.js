...
$(window).on("load", function () {
  ...
  var multiradialChart2 = new ApexCharts(
    document.querySelector("#multi-radial-chart2"),
    multiRadialOptions2
  );
  multiradialChart2.render();

  // Multi Radial Statistics dankos
  // -----------------------
  var multiRadialOptions3 = {
    chart: {
      height: 210,
      type: "radialBar",
    },
  ...
  var multiradialChart3 = new ApexCharts(
    document.querySelector("#multi-radial-chart3"),
    multiRadialOptions3
  );
  multiradialChart3.render();

  // Multi Radial Statistics hj
  // -----------------------
  var multiRadialOptions4 = {
    chart: {
      height: 210,
      type: "radialBar",
    },
  ...
  var multiradialChart4 = new ApexCharts(
    document.querySelector("#multi-radial-chart4"),
    multiRadialOptions4
  );
  multiradialChart4.render();

  // Multi Radial Statistics fima
  // -----------------------
  var multiRadialOptions5 = {
    chart: {
      height: 210,
      type: "radialBar",
    },
  ...
  var multiradialChart5 = new ApexCharts(
    document.querySelector("#multi-radial-chart5"),
    multiRadialOptions5
  );
  multiradialChart5.render();

  // Multi Radial Statistics gof
  // -----------------------
  var multiRadialOptions6 = {
    chart: {
      height: 210,
      type: "radialBar",
    },
  ...
  var multiradialChart6 = new ApexCharts(
    document.querySelector("#multi-radial-chart6"),
    multiRadialOptions6
  );
  multiradialChart6.render();
