        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item"><a class="navbar-brand" href="../html/index.php">
                        <div class="brand-logo"><img class="logo" src="../app-assets/images/logo/fima.png"></div>
                    </a></li>
            </ul>
        </div>
                    ...
                    <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">PT Finusolprima Farma Internasional</h4>
                                        </div>
                                        <div class="card-body">
                                            <iframe src="https://www.google.com/maps/embed?pb=!4v1649402949661!6m8!1m7!1sC_mK43IsHfPNnJ-8iCUcBg!2m2!1d-6.215441205653855!2d106.9724361170594!3f167.12898953954908!4f-7.584190134088345!5f0.7820865974627469" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                        </div>
                                    </div>
                                </div>
                                <!-- Layer Control ends -->
                        ...
                        <div class="col-xl-7">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card-body">
                                        <div id="multi-radial-chart5"></div>
