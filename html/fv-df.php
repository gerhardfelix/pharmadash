        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item"><a class="navbar-brand" href="../html/index.php">
                        <div class="brand-logo"><img class="logo" src="../app-assets/images/logo/dankos.png"></div>
                    </a></li>
            </ul>
        </div>
                        ...
                        <div class="col-xl-5">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">PT Dankos Farma</h4>
                                        </div>
                                        <div class="card-body">
                                            <iframe src="https://www.google.com/maps/embed?pb=!4v1649403478868!6m8!1m7!1sHk2V48cYZfXipmEGH6MwrA!2m2!1d-6.205734853677554!2d106.9095261078606!3f120.09628108792776!4f-1.1622096801492745!5f0.7820865974627469" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                        </div>
                                    </div>
                                </div>
                                <!-- Layer Control ends -->
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-1 mb-lg-0">
                                    <a href="maintenance.php"><button type="button" class="btn btn-primary btn-lg btn-block">Line View </button></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-7">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card-body">
                                        <div id="multi-radial-chart3"></div>
