        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item"><a class="navbar-brand" href="../html/index.php">
                        <div class="brand-logo"><img class="logo" src="../app-assets/images/logo/onkolab.png"></div>
                    </a></li>
            </ul>
        </div>
                    ...
                    <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">PT Global Onkolab Farma</h4>
                                        </div>
                                        <div class="card-body">
                                            <iframe src="https://www.google.com/maps/embed?pb=!4v1649403379533!6m8!1m7!1se7Bzo9LBQy_sNx9wIQtk7g!2m2!1d-6.204796945517839!2d106.9100868939932!3f135.73555984736794!4f-1.8802136449330646!5f0.7820865974627469" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                        </div>
                                    </div>
                                </div>
                                <!-- Layer Control ends -->
                        ...
                        <div class="col-xl-7">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card-body">
                                        <div id="multi-radial-chart6"></div>
